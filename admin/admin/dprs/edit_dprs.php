...
<div class="card card-success">
	...
	<form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group row">
				<label class="col-sm-2 col-form-label">Nomor Sistem</label>
				<div class="col-sm-6">
			...
			<div class="form-group row">
                ...
                if ($data_cek['level'] == "Kepala Sks") echo "<option value='Kepala Sks' selected>Kepala Sks</option>";
                else echo "<option value='Kepala Sks'>Kepala Sks</option>";

				if ($data_cek['level'] == "Perusahaan") echo "<option value='Perusahaan' selected>Perusahaan</option>";
