<?php
    ...
    if(isset($_GET['kode'])){
        $sql_cek = "SELECT p.nama, d.id_pindah, d.alamat_pindah, d.tgl_pindah, d.alasan FROM 
	...
	<form action="" method="post" enctype="multipart/form-data">
		<div class="card-body">
			...
			<div class="form-group row">
				...
				<div class="col-sm-6">
					<input type="text" class="form-control" id="alamat_pindah" name="alamat_pindah" value="<?php echo $data_cek['alamat_pindah']; ?>"
					 required>
				</div>
			</div>
