<div class="card card-primary">
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<div class="form-group row">
			...
			<div class="form-group row">
				<label class="col-sm-2 col-form-label">Upload Data SK Izin</label>
				<div class="col-sm-2">
...
<?php
    ...
    //mulai proses simpan data
        ...
        $sql_simpan = "INSERT INTO tb_umum (umum_id, id_kawasan, pbphh, jenis, alamat, email, notelp, doc) VALUES (
            '".$_POST['umum_id']."',
			'".$_POST['id_kawasan']."',
			'".$_POST['pbphh']."',
            '".$_POST['jenis']."',
