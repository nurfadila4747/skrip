...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 27, 2023 at 08:36 AM
...
CREATE TABLE `tb_anggota` (
  ...
  `jenis_anggota` enum('Perusahaan','Koperasi') NOT NULL,
  `password` varchar(20) NOT NULL,
  `level` char(10) NOT NULL DEFAULT 'Perusahaan',
...
INSERT INTO `tb_anggota` (`id_anggota`, `nama`, `jenis_anggota`, `password`, `level`, `status`) VALUES
('AKN001', 'PT. Hutan Kusuma', 'Perusahaan', '123', 'Perusahaan', 'Non Aktif'),
('AKN002', 'PT. Kiani Lestari', 'Perusahaan', '6358', 'Perusahaan', 'Non Aktif');
...
INSERT INTO `tb_berita` (`id_berita`, `judul`, `penerbit`, `tgl`, `filee`) VALUES
('B001', 'Juknis Perubahan RKT dan Pelaporan', 'Mentri Lingkungan Hidup dan Kehutanan', '2023-03-25', 'PANDUAN PERUBAHAN RKTPH & PELAPORAN SIPBPH.pdf'),
('B002', 'Juknis Perubahan Blok RKUPH', 'Mentri Lingkungan Hidup dan Kehutanan', '2023-03-25', 'PANDUAN PERUBAHAN BLOK RKUPH SIPBPH.pdf'),
('B003', 'Panduan Penyusunan & Pengesahan RKTPH Tahun 2023', 'Mentri Lingkungan Hidup dan Kehutanan', '2023-03-25', '1. Panduan Penyusunan dan Pengesahan RKTPH  Tahun 2023_5Des.pptx.pdf'),
('B004', 'Tata Perhitungan Target Volume RKTPH Data ITSP', 'Mentri Lingkungan Hidup dan Kehutanan', '2023-03-25', '2. Tata Cara Penghitungan Target Volume RKTPH - Data ITSP_4Nov.pdf'),
('B005', 'Cara Pengisian Data JPT & Penyusunan RKTPH 2023 pada SI PBPH', 'Mentri Lingkungan Hidup dan Kehutanan', '2023-03-25', '3. Tata Cara Pengisian Data JPT dan Penyusunan RKTPH 2023 pada SIPBPH_5Des.pdf');

-- --------------------------------------------------------

--
-- Table structure for table `tb_brku`
--

CREATE TABLE `tb_brku` (
  `id_brku` varchar(10) NOT NULL,
  `judul` varchar(100) NOT NULL,
  `penerbit` varchar(100) NOT NULL,
  `tgl` date NOT NULL,
  `filee` varchar(200) NOT NULL
...
--
-- Dumping data for table `tb_brku`
--

INSERT INTO `tb_brku` (`id_brku`, `judul`, `penerbit`, `tgl`, `filee`) VALUES
('BR001', 'Manual Book RKU-RKU', 'Mentri Lingkungan Hidup dan Kehutanan', '2023-03-25', 'Manual Book RKU-RKT.pdf'),
('BR002', 'SE.8 PHL', 'Mentri Lingkungan Hidup dan Kehutanan', '2023-03-25', 'SE.8 PHL.pdf'),
('BR003', 'PERMENLHK', 'Mentri Lingkungan Hidup dan Kehutanan', '2023-03-25', 'PERMENLHK.pdf');
...
CREATE TABLE `tb_koreksi` (
  `id_koreksi` varchar(20) NOT NULL,
...
CREATE TABLE `tb_pengguna` (
  ...
  `password` varchar(20) NOT NULL,
  `level` enum('Administrator','KepalaSeksi') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(6, 'Nanang Hayani', 'sks', '123', 'KepalaSeksi'),
(7, 'dila aja', 'dila', '1', 'Administrator');
...
CREATE TABLE `tb_rkt` (
  ...
  `keperluan` enum('Upload RKT','Revisi RKT') NOT NULL,
  `keterangan` text NOT NULL,
  `tgl_out` date NOT NULL,
  `tgl_in` date NOT NULL,
  `status` enum('Proses','Verifikasi','Ditolak','Berakhir') NOT NULL,
...
INSERT INTO `tb_rkt` (`id_izin`, `id_umum`, `keperluan`, `keterangan`, `tgl_out`, `tgl_in`, `status`, `berkas`, `author`) VALUES
('RKT001', 1, 'Upload RKT', 'Menembuskan laporan aktifitas lapangan ke Dishut', '2023-03-08', '2023-03-18', 'Proses', 'lia.pdf', 'AKN001');
...
('2362783678', 1, 'PT. Hutan Lestari', '2023-03-01', '2023-03-18', 'Penyelesaian Penelitian Skripsi'),
...
INSERT INTO `tb_umum` (`id_umum`, `umum_id`, `id_kawasan`, `pbphh`, `jenis`, `alamat`, `email`, `notelp`, `doc`) VALUES
(1, '339/Kpts-II/1998', 1, 'PT. Hutan Kusuma', 'HT', 'Wisma Idola Tunggal Jalan Letjen S.Parman Kav 67, Silpi Jakarta Barat', 'HutanKusuma01@gmail.com', '6285705463158', 'SE.8 PHL.pdf'),
(2, '20/Kpts-II/1998', 1, 'PT. Belantara Pusaka', 'HT', 'Wisma Indocement Lantai 12 Jl. Jend. Sudirman Kav. 70-71', 'belantarapusaka.pt@gmail.com', '(021) 2510461', 'SE.8 PHL.pdf'),
(3, 'SK.581/MENLHK/SETJEN/HPL.0/9/2021', 1, 'PT. Belantara Persada', 'HA&HT', 'Wisma Indocement Lantai 12 Jl. Jend. Sudirman Kav. 70-71', 'belantara.kaltim@gmail.com', '(021) 6338670', 'SE.8 PHL.pdf'),
(4, 'SK.116/Menhut-II/2014', 1, 'PT. Narkata Rimba', 'HA', 'JI. Syahrani Dahlan No. 09. Komplek Pesona Mahakam Kel. Harapan Baru. Kec.Loa Janan Ilir. Samarinda.', 'phsamarinda1@gmail.com', '0541-7268020', 'SE.8 PHL.pdf'),
(5, ' -', 7, 'PT. ITCI Hutani Manunggal', 'HA&HT', ' Jl.Mulawarman', 'ictii@gamil.com', '  97786775656', ''),
(6, 'SK.97/Menhut-ll/2008', 4, 'PT. Seroja Universum Narwastu', 'HA', 'Jl. K. H. Anang Hasyim Komplek PWI Blok B No. 35. RT. 20, Air hitam, Samarinda', 'ptsunarwastu@gmail.com', '(0541)2088234', 'SE.8 PHL.pdf'),
...
--
-- Indexes for table `tb_brku`
--
ALTER TABLE `tb_brku`
  ADD PRIMARY KEY (`id_brku`);
